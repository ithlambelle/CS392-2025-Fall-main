...
public class FnListTest {
    ...
    private static void testSorting() {
        System.out.println("\n--- Testing Sorting Helpers ---");
        
        FnList<Integer> nums = new FnList<>(3, new FnList<>(1, new FnList<>(4, new FnList<>(1, new FnList<>(5, new FnList<>())))));
        
        FnList<Integer> inserted = FnListUtil.insertSort(nums);
        System.out.print("Insertion sort: ");
        inserted.System$out$print();
        System.out.println(" ordered? " + FnListUtil.orderedq(inserted));
        
        FnList<Integer> merged = FnListUtil.mergeSort(nums);
        System.out.print("Merge sort: ");
        merged.System$out$print();
        System.out.println(" ordered? " + FnListUtil.orderedq(merged));
        
        FnList<Integer> quick = FnListUtil.quickSort(nums);
        System.out.print("Quick sort: ");
        quick.System$out$print();
        System.out.println(" ordered? " + FnListUtil.orderedq(quick));
    }
